        ...
        <div class="modal-content cmp-reset-modal">
            <div class="modal-header cmp-pw-header">
                <h4 class="modal-title" id="resetPasswordModalLabel">
                    <i class="fas fa-key"></i> Reset VM Password
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group text-center">
                    ...
                    <div class="cmp-pw-row">
                        ...
                        <button type="button" class="btn btn-default cmp-pw-toggle" id="btn-toggle-vm-password" title="Show password" aria-label="Show password">
                            <i class="fas fa-eye"></i>
                        </button>
                        <button type="button" class="btn btn-default cmp-pw-generate" id="btn-generate-vm-password" title="Generate a strong password">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger cmp-pw-submit" id="btn-submit-password">
                    <i class="fas fa-key"></i> Reset Password
                </button>
            </div>
        </div>
...
<style>
    ...
    .cmp-reset-modal .modal-header .close:hover { opacity: 1; }
    ...
    .cmp-reset-modal .cmp-pw-hint-list li {
        display: flex;
        align-items: center;
        padding: 2px 0;
        line-height: 1.5;
    ...
    .cmp-reset-modal .cmp-pw-hint-list li .cmp-pw-hint-icon {
    ...
    .cmp-reset-modal .cmp-pw-submit { background-image: linear-gradient(90deg, #e53e5f 0%, #d9534f 100%); border: none; }
    .cmp-reset-modal .cmp-pw-submit:hover { background-image: linear-gradient(90deg, #d9534f 0%, #c9302c 100%); }
</style>
...
(function() {
    ...
    function generateStrongPassword(len) {
        ...
        var pw = pick(upper) + pick(lower) + pick(digits) + pick(special);
        for (var i = pw.length; i < len; i++) pw += pick(all);
    ...
    function evaluatePasswordHint(pw) {
        ...
        PW_POLICY.forEach(function(rule, i) {
            ...
            if (rule(pw)) {
                ...
                if (li) li.className = 'bad';
                allOk = false;
                errors.push(PW_LABELS[i]);
            }
        });
    ...
    function validatePasswordPolicy(pw) {
        return evaluatePasswordHint(pw).errors;
    }
    ...
    $(document).ready(function() {
        ...
        $('#btn-submit-password').on('click', function() {
            ...
            var errors = validatePasswordPolicy(pw);
            var $alert = $('#reset-pw-alert');
            if (errors.length) {
                $alert.attr('class', 'alert alert-danger')
                      .text('Password must contain ' + errors.join(', ') + '.').show();
                return;
            }
